...
export default function AdminProfile() {
  ...
  const MENU = [
    { icon: 'user' as const, color: '#CC0D00', bg: '#FEE5E3', label: 'Thông tin cá nhân', onPress: () => router.push('/edit-profile') },
    { icon: 'bell' as const, color: '#D97706', bg: '#FEF3C7', label: 'Thông báo', onPress: () => router.push('/notifications') },
    { icon: 'lock' as const, color: '#16A34A', bg: '#DCFCE7', label: 'Đổi mật khẩu', onPress: () => router.push('/edit-profile') },
        ...
        <View style={{ gap: 14 }}>
          ...
          >
            ...
            <View className="bg-[#FEE5E3] rounded-full" style={{ paddingVertical: 3, paddingHorizontal: 10 }}>
              <Text className="text-[#CC0D00] text-[11px] font-bold">ADMIN</Text>
            </View>
